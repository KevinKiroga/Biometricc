...
class AuthController extends Controller
{
    ...
    // Metodo para redireccionar al registro
    ...
    // Metodo para redireccionar la contraseña
    ...
    // Metodo para restablecer la contraseña
    public function resetPassword($token){
        return view('auth.resetPassword', ['token' => $token]);
    }

    // Metodo para editar la contraseña
    ...
    {
        $user = auth()->user();
        return view('home.layout.masterPage' , compact('user'));
    }
